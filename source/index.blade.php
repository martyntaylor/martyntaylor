    ...
    <div class="flex-auto w-full container max-w-4xl mx-auto px-6">
        <div>
          ...
          <p class="mt-3 text-xl leading-7 text-gray-500 sm:mt-4">
            17+ years experience working in both agencies and internal development teams. Led teams and managed departments as well as attaining an AgilePM certification.
          </p>
          <p class="mt-3 text-xl leading-7 text-gray-500 sm:mt-4">
